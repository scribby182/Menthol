...
class TestTransactions2(TestCase):
    ...
    def test_summarize_transactions(self):
        ...
        # Averaged monthly
        summarized = trxs.summarize_transactions()
        ...
        # Averaged 3-monthly
        summarized = trxs.summarize_transactions(n_months = 3)
        ...
        summarized = trxs.summarize_transactions(start = start, stop = end, n_months = 1)
        ...
        # Averaged 3-monthly
        summarized = trxs.summarize_transactions(start = start, stop = end, n_months = 3)
